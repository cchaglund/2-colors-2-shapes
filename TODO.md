...
- when clicking on a single submission from the list view it should NOT open in a new tab, just navigate in the same tab.
...
- calendar view should show the colors and shapes for each day, to see it quickly at a glance.
