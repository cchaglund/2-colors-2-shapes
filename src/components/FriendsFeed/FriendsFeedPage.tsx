...
import { FriendsFeedContent } from './FriendsFeedContent';
import { useAuth } from '../../hooks/useAuth';
import { useSubmissions } from '../../hooks/useSubmissions';
import { getTodayDateUTC } from '../../utils/dailyChallenge';

interface FriendsFeedPageProps {
  date: string;
}

export function FriendsFeedPage({ date }: FriendsFeedPageProps) {
  const { user } = useAuth();
