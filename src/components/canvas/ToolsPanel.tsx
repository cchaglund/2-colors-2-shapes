...
function ToolButton({ icon, label, shortcut, onClick, disabled, active }: ToolButtonProps) {
  ...
  return (
    <div className="relative">
      ...
      {isHovered && (
        <div className="absolute left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1.5 rounded-(--radius-sm) text-[11px] whitespace-nowrap z-50 pointer-events-none bg-(--color-bg-primary) text-(--color-text-primary) border border-(--color-border) shadow-sm">
