  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="px-3 py-1.5 rounded-md text-sm font-medium transition-colors disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer flex items-center gap-1 bg-(--color-bg-tertiary) text-(--color-text-primary) hover:bg-(--color-hover)"
      >
        <svg
          width="14"
          height="14"
